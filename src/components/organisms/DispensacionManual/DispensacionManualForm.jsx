...
import { useDispensacionManualForm } from "src/hooks";
...
import { UltimasOrdenesYComentario } from "./UltimasOrdenes";
import { ResumenPago } from "./ResumenPago";

export const DispensacionManualForm = () => {
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="bg-white p-2 rounded-lg shadow-lg w-full h-full flex flex-col gap-5">
        ...
        <div className="w-full flex justify-center gap-3">
          <IconButton
            ...
            icon={FaSave}
            type="submit"
            disabled={!isValid || !hayOrdenesValidas || totalGeneral !== valorPagado}
          />
